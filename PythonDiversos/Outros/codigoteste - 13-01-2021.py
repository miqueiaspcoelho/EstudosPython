    ...
    if ponteiro !=None:
        ...
        while final==None and ponteiro==None:
            ...
            if ponteiro !=None:
                ...
                pt.scroll(-100)
                final=pt.locateOnScreen ('C:/Users/mique/Desktop/botTeste/ContatoFinal.PNG', confidence=0.7)
        ...
        while topo==None and ponteiro==None:
            ...
            if ponteiro !=None:
                ...
                pt.scroll(100)
                topo=pt.locateOnScreen ('C:/Users/mique/Desktop/botTeste/ContatoTopo.PNG', confidence=0.8)
